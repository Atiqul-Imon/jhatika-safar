          ...
          <nav className="hidden md:flex space-x-8">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  'text-gray-800 hover:text-green-600 px-3 py-2 text-base font-semibold transition-colors duration-200',
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  'text-gray-800 hover:text-green-600 block px-3 py-2 text-lg font-semibold',
